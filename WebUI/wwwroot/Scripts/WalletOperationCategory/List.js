...
var List = {
        ...
        Backend.Post(
            ...
            function (response) {
                ...
                if (response.Data.length == 0) {
                    $("#tableRows").html('<tr><td colspan="100%"><h5 class="alert alert-danger" style="text-align:center;width:100%;">Kategori Bulunamadı...</h5><tr><td>');
                    return;
                }
    ...
    AddRows: function (rows) {
        ...
        for (var i in rows) {
            ...
            htmlRows += '<tr class="GridRow" onmouseout="this.className=\'GridRow\'" onmouseover="this.className=\'GridRowOver\'">'
                ...
                + '<td style="text-align:center;" ><button class="btn btn-outline-info btn-sm" onclick="List.FindForEdit(' + row.ID + ',this)"><i class="fas fa-edit"></i> Düzenle</button></td>'
                + '</tr>';
        }
    ...
    AddDialog: function () {
        var htmlContent = ''
            ...
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control  tabkey" name="Name" id="addDescription" />'
            + '        </div>'
            + '    </div>'
    ...
    EditDialog: function (entity) {
        var htmlContent = ''
            ...
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control  tabkey" name="Name" id="editDescription" value="' + entity.Description + '" />'
            + '        </div>'
            + '    </div>'
    ...
    DeleteDialog: function () {
        var htmlContent = ''
            ...
            + '<div style="margin-top:3px;" class="alert alert-danger" id="DeleteDialogError">Seçtiğiniz Kategori silinecektir.<br>Onaylıyor musunuz?</div>'

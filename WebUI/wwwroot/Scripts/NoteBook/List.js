...
var List = {
    ...
    Columns: [
        ...
        { name: "Ad", width: "50%", sort: "Name" },
        { name: "Değer", width: "50%", sort: "" },
        { name: "Açıklama", width: "50%", sort: "" },
    ...
    AddRows: function (rows) {
        ...
        for (var i in rows) {
            ...
            htmlRows += '<tr class="GridRow" onmouseout="this.className=\'GridRow\'" onmouseover="this.className=\'GridRowOver\'">'
                ...
                + '<td style="text-align:center;" ><button class="btn btn-outline-danger btn-sm" onclick="List.DeleteDialog(' + row.ID + ',this)">Sil</button></td>'
                + '</tr>';
        }
    ...
    AddDialog: function () {
        var htmlContent = ''
            ...
            + '        <label for="addName" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Ad</label>'
            ...
            + '    <div class="form-group row  col-md-12 col-lg-12 col-sm-12 col-xs-12">'
            + '        <label for="addValue" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Değer</label>'
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control  tabkey" name="Value" id="addValue" />'
            + '        </div>'
            + '    </div>'
            ...
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <textarea id="addDescription" name="addDescription" class="form-control" style="min-height:20vh;"></textarea>'
            + '        </div>'
            + '    </div>'
    ...
    Add: function () {
        ...
        if ($('#addValue').val() == '') {
            $('#AddDialogError')
                .html('Lütfen Not değeri giriniz.')
                .show()
            $('#addValue').css('border', '1px solid #f33')
            return;
        }
    ...
    EditDialog: function (entity) {
        var htmlContent = ''
            ...
            + '    <div class="form-group row  col-md-12 col-lg-12 col-sm-12 col-xs-12">'
            + '        <label for="editValue" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Adı</label>'
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control  tabkey" name="Value" id="editValue" value="' + entity.Value + '" />'
            + '        </div>'
            + '    </div>'
            ...
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '             <textarea id="editDescription" name="editDescription" class="form-control" style="min-height:20vh;">' + entity.Description + '</textarea>'
            + '        </div>'
            + '    </div>'
    ...
    Edit: function () {
        ...
        if ($('#editValue').val() == '') {
            $('#EditDialogError')
                .html('Lütfen Not Değeri giriniz.')
                .show()
            $('#editValue').css('border', '1px solid #f33')
            return;
        }
    ...
    DeleteDialog: function (id) {
        var htmlContent = ''
            ...
            + '<div style="margin-top:3px;" class="alert alert-danger" id="DeleteDialogError">Seçtiğiniz Not silinecektir.<br>Onaylıyor musunuz?</div>'

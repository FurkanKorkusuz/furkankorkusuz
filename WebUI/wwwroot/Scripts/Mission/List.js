...
var List = {
    ...
    Columns: [
        ...
        { name: "Adı", width: "50%", sort: "MissionName" },
        { name: "Başlangıç", width: "20%", sort: "" },
        { name: "Bitiş", width: "20%", sort: "" },
    ...
    AddDialog: function () {
        var htmlContent = ''
            ...
            + '        <label for="addMissionName" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Adı</label>'
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control  tabkey" name="MissionName" id="addMissionName" />'
            + '        </div>'
            + '    </div>'


            + '    <div class="form-group row  col-md-12 col-lg-12 col-sm-12 col-xs-12">'
            + '        <label for="addStartDate" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Başlangıç</label>'
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control datepicker tabkey" name="StartDate" id="addStartDate" />'
            + '        </div>'
            + '    </div>'

            + '    <div class="form-group row  col-md-12 col-lg-12 col-sm-12 col-xs-12">'
            + '        <label for="addEndDate" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Bitiş</label>'
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <input type="text" class="form-control datepicker tabkey" name="EndDate" id="addEndDate" />'
            + '        </div>'
            + '    </div>'

            + '    <div class="form-group row  col-md-12 col-lg-12 col-sm-12 col-xs-12">'
            + '        <label for="addEndDate" class="col-md-4 col-lg-4 col-sm-4 col-xs-4 col-form-label">Açıklama</label>'
            + '        <div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">'
            + '            <textarea id="addDescription" class="form-control" style="min-height:30vh;"></textarea>'
            + '        </div>'
            + '    </div>'
    ...
    Add: function () {
        ...
        var prt = {
            ID: 0,
            MissionName: $('#addMissionName').val(),
